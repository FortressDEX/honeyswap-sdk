...
export const STAKING_REWARDS_FACTORY_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.CANDLE]: '0x0000000000000000000000000000000000001234',
}
...
export const TOKEN_REGISTRY_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.MATIC]: '0x0000000000000000000000000000000000001234',
  [ChainId.CANDLE]: '0x2d82cBA62Be66e8c0e4A05e633fA90f33f7846b1' // deployed on Candle now
}
...
export const INIT_CODE_HASH: { [chainId: number]: string } = {
  ...
  [ChainId.CANDLE]: '0x0f8c68f2d5cde1719200e509fb5d5119537c584c8098ba60ec30981d4d0fc5c1' // candle
}
...
const PERMISSIVE_MULTICALL_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.CANDLE]: '0xb5cEE8f223397D01e517070E3CF4DA215baAc673'
}
